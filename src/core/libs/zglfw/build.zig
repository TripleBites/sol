...
pub fn build(b: *std.Build) void {
    ...
    inline for (field_names) |field_name| {
        options_step.addOption(
            @TypeOf(@field(options, field_name)),
            field_name,
    ...
    tests.root_module.addImport("glfw_c", glfw_c_mod);
